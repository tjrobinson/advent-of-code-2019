...
namespace AdventOfCode2019.Tests.Day2
{
    public class Day2Part1Tests
    {
        ...
        {
            var day2 = new IntCodeComputer(input, new FixedInputProvider(1), new ConsoleOutputHandler());
        ...
        public void MyPuzzleInput()
        {
            ...
            var day2 = new IntCodeComputer(puzzleInput, new FixedInputProvider(1), new ConsoleOutputHandler());
