...
namespace AdventOfCode2019.Console
{
    public static class Day5
    {
        public static void Testing()
        {
            ...
            var day5 = new IntCodeComputer(puzzleInput, new FixedInputProvider(20), new ConsoleOutputHandler());
            day5.Execute();
        ...
        public static void PuzzleInput()
        {
            ...
            var day5 = new IntCodeComputer(puzzleInput, new FixedInputProvider(5), new ConsoleOutputHandler());
            day5.Execute();
